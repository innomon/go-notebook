...
- [ ] Task: Write unit tests verifying docx parsing from mock ZIP/XML structure
    - [ ] Add test cases in `internal/extractor/docx_test.go` using mock docx ZIP data.
- [ ] Task: Implement docx XML parsing using archive/zip and encoding/xml
    - [ ] Create `internal/extractor/docx.go` to parse paragraphs and tables from docx zip.
